  ...
  return (
    <div id="upsideDown" className={`App ${isFlipped ? "onHead" : ""} `}>
      <header className={`main `}>
        ...
        <p>The Best Kenny Solving Tool Out There</p>
        <div className="faces">
          <img
        ...
        >
          {isFlipped
            ? "You flipped it. You proud?"
            : "Totally doesn't flip the face"}
        </button>
        <button
          className={`flipper ${isFlipped ? "onHead" : ""}`}
          onClick={flipThatSucker}
      ...
      <footer>
        <div>
          <a href="https://www.github.com/christianarty/StandOnYourHead">
            <img src={theSource} alt="Link to the source repo"></img>
          </a>
        </div>
        by Christian Arty
      </footer>
